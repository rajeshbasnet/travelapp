...
export default function AttractionList({ place, navigation }) {
    ...
    return (
        <TouchableOpacity onPress={() => navigation.navigate("attraction_detail", { xid })}>
            <View className="px-2 py-2 mx-2 my-4 h-32 rounded-xl flex flex-row items-center bg-white relative">
                {/** Hotel Image */}
                <View>
                    <Image src={source} className="w-24 h-full rounded-xl" resizeMode="cover" />
                </View>
                ...
                <View className="ml-4">
                    <View className="w-[210px] overflow-hidden">
                        ...
                        <View className="flex-row items-baseline">
                            ...
                            <Text className="text-gray-400 font-[BalooBold] text-lg ml-1">3</Text>
                        </View>
                    </View>
                </View>
