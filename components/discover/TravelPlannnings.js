import { View, Text, ScrollView, ImageBackground, TouchableWithoutFeedback, TouchableOpacity } from "react-native";
    ...
    return (
        <View className="mt-6 z-[-1]">
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                ...
                <TouchableOpacity className="relative w-[300px] h-[150px] ml-4" onPress={() => navigation.navigate("attraction")}>
                    <View className="w-full h-full">
                        <ImageBackground
                            key={"attraction"}
                            source={Attraction}
